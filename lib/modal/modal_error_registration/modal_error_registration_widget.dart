...
import 'modal_error_registration_model.dart';
export 'modal_error_registration_model.dart';

/// модульное окно ошибки
class ModalErrorRegistrationWidget extends StatefulWidget {
  ...
  @override
  State<ModalErrorRegistrationWidget> createState() =>
      _ModalErrorRegistrationWidgetState();
}

class _ModalErrorRegistrationWidgetState
    extends State<ModalErrorRegistrationWidget> {
  late ModalErrorRegistrationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalErrorRegistrationModel());
  }
