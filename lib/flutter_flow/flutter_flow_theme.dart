...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFFC2C2C2);
  late Color alternate = const Color(0xFFE8E4DE);
  late Color primaryText = const Color(0xFF2D302E);
  late Color secondaryText = const Color(0xFF7A7A7A);
  late Color primaryBackground = const Color(0xFFFAF7F2);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFE8DCC4);
  ...
  late Color hint = const Color(0xFFC2C2C2);
  late Color divider = const Color(0xFFE8E4DE);
  late Color text = const Color(0xFF111111);
  late Color outline = const Color(0xFFE8E4DE);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF8C9985);
  late Color secondary = const Color(0xFFB08989);
  late Color tertiary = const Color(0xFF5C5C5C);
  late Color alternate = const Color(0xFF333634);
  late Color primaryText = const Color(0xFFFAF7F2);
  late Color secondaryText = const Color(0xFFA8A8A8);
  late Color primaryBackground = const Color(0xFF1A1C1A);
  late Color secondaryBackground = const Color(0xFF252826);
  late Color accent1 = const Color(0xFFD1C4AC);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
  ...
  late Color hint = const Color(0xFF5C5C5C);
  late Color divider = const Color(0xFF333634);
  late Color text = const Color(0xFF111111);
  late Color outline = const Color(0xFF333634);
}
...
class FFShadows {
  ...
  BoxShadow get sm => const BoxShadow(
      blurRadius: 4.0,
      color: const Color(0x0D4A4A4A),
      offset: const Offset(0.0, 2.0),
      spreadRadius: 0.0);
  BoxShadow get md => const BoxShadow(
      blurRadius: 8.0,
      color: const Color(0x144A4A4A),
